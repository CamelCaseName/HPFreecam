...
internal class FFreecam
{
    ...
    private void UpdateThirdPersonCameraPositions()
    {
        ...
        player.Head.transform.get_position_Injected(out var gamePos);
